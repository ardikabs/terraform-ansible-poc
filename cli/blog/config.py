...
class ConfigFileProcessor(ConfigFileReader):
    config_files = ["blog.cfg", "blog.ini"]
    config_searchpath = ["."]
    config_section_schemas = [
        ConfigSectionSchema.Defaults,
        ConfigSectionSchema.SSH,
        ConfigSectionSchema.Cloud,
        ConfigSectionSchema.SwarmCluster
    ]
